...
const categories = [
    { name: 'Progressivas', slug: 'progressivas', link: 'categorias/progressivas/index.html', active: true },
    { name: 'Máscaras Capilares', slug: 'mascaras', link: 'categorias/mascaras/index.html', active: true },
    { name: 'Escovas & Pentes', slug: 'escovas', link: 'categorias/escovas/index.html', active: true },
    { name: 'Tratamentos', slug: 'tratamentos', link: 'categorias/tratamentos/index.html', active: true },
    { name: 'Extensões', slug: 'extensoes', link: 'categorias/extensoes/index.html', active: true }
];
...
const products = [
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/progressiva-liso-magico/images/capa.png',
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/progressiva-liss-gold/images/capa.jpeg',
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/organic-lizz/images/capa.webp',
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/progressiva-love-lizz/images/D_NQ_NP_2X_886189-MLB80285201091_102024-F.webp',
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/liso-therapy/images/capa.png',
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/progressiva-liss-divine/images/1.jpg',
    ...
    },
    {
      ...
      category: 'progressivas',
      stars: 5,
      image1: 'produtos/lumiliss/images/capa.png',
    ...
    },
    {
      ...
      category: 'mascaras',
      stars: 5,
      image1: 'produtos/mascara-explosao/images/capa.png',
    ...
    },
    {
      ...
      category: 'mascaras',
      stars: 5,
      image1: 'produtos/mascara-vita/images/capa.png',
    ...
    },
    {
      ...
      category: 'mascaras',
      stars: 5,
      image1: 'produtos/mascara-desmaia-cabelo/images/capa.jpg',
    ...
    },
    {
      ...
      stars: 5,
      image1: 'produtos/melanine-hair/images/capa.png',
    ...
    },
    {
      ...
      category: 'tratamentos',
      stars: 5,
      image1: 'produtos/ativador-de-crescimento/images/capa.jpeg',
    ...
    },
    {
      ...
      category: 'tratamentos',
      stars: 5,
      image1: 'produtos/creatina-cabelo-unha/images/capa.png',
    ...
    },
    {
      ...
      category: 'escovas',
      stars: 5,
      image1: 'produtos/escova-alisadora/images/capa.jpg',
    ...
    },
    {
      ...
      category: 'tratamentos',
      stars: 5,
      image1: 'produtos/shampoo-antirresíduo/images/capa.jpg',
...
async function seed() {
    ...
    // Get categories to link them correctly if products.category is an FK
    ...
    for (const p of products) {
        // If the DB expects an integer for category, we try to map it, otherwise we keep the slug
        // Actually, looking at the error, price was the main issue.
        // I'll keep the category as it is for now, for safety if it's a TEXT column it works.
        const { error: prodErr } = await supabase.from('products').upsert(p, { onConflict: 'slug' });
        if (prodErr) {
            console.error(`Error on ${p.slug}:`, prodErr.message);
            // Retry without the category field if it fails specifically on that
            if (prodErr.message.includes('category')) {
                const { category, ...rest } = p;
                await supabase.from('products').upsert(rest, { onConflict: 'slug' });
            }
        } else {
    ...
    const { error: homeErr } = await supabase.from('site_settings').upsert({ key: 'home_data', value: homeSettings }, { onConflict: 'key' });
    if (homeErr) console.error('Home settings error:', homeErr.message);
    else console.log('Home settings seeded!');
